package com.ice.ztest.test;

import misc.Misc;

public class CRCTest {
	public static void main(String[] args) {
		byte[] len = new byte[20];
		for (int i = 0; i < 10; i++) {
			len[i] = (byte) i;
		}
		System.out.println(len.length);
		System.out.println(Misc.printBytes(len));
		
		int crc = CRCTest.CRC("0405");
		System.out.println(crc);// 2000312047
		int calcCrc16 = CRCTest.calcCrc16("0405".getBytes());
		System.out.println(Integer.toHexString(calcCrc16));
		String crc2 = CRCTest.getCRC("0405".getBytes());
